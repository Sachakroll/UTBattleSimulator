...
if owner.type = "bone hor"
{
	...
	if owner.base = "bottom"
	{
		...
		draw_sprite(sAtk_bone_hor, 0, _x-surf_x, _y-surf_y)
		draw_rectangle_colour(_x-2-surf_x, _y-surf_y, _x+3-surf_x, _y+h-surf_y, c_white, c_white, c_white, c_white, 0)
		draw_sprite(sAtk_bone_hor, 1, _x-surf_x, _y+h-surf_y)
	}
	if owner.base = "top"
	{
		var h = 1 + _y - (oBattle.box_bottom-oBattle.box_height) - sh
		draw_sprite(sAtk_bone_hor, 1, _x-surf_x, _y-surf_y)
		draw_rectangle_colour(_x-2-surf_x, _y-surf_y, _x+3-surf_x, _y-h-surf_y, c_white, c_white, c_white, c_white, 0)
		draw_sprite(sAtk_bone_hor, 0, _x-surf_x, _y-h-surf_y)
	}
...
if owner.type = "bone vert"
{
	...
	if owner.base = "right"
	{
		...
		draw_sprite(sAtk_bone_vert, 1, _x-surf_x, _y-surf_y)
		draw_rectangle_colour(_x-surf_x, _y-2-surf_y, _x+h-surf_x, _y+3-surf_y, c_white, c_white, c_white, c_white, 0)
		draw_sprite(sAtk_bone_vert, 0, _x+h-surf_x, _y-surf_y)
	}
	if owner.base = "left"
	{
		var h = 1 - (160-oBattle.box_width/2) + _x - sw
		draw_sprite(sAtk_bone_vert, 0, _x-surf_x, _y-surf_y)
		draw_rectangle_colour(_x-surf_x, _y-2-surf_y, _x-h-surf_x, _y+3-surf_y, c_white, c_white, c_white, c_white, 0)
		draw_sprite(sAtk_bone_vert, 1, _x-h-surf_x, _y-surf_y)
	}
